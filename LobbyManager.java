...
public class LobbyManager {
	...
	public synchronized GameRoom createRoom(ClientHandler owner) {
		int id = nextRoomId.getAndIncrement();
		GameRoom room = new GameRoom(id, owner, this);
		rooms.put(id, room);
		return room;
	}

	// join an existing room by id
	public synchronized GameRoom joinRoom(int roomId, ClientHandler joiner) {
	...
	// remove a room from the lobby (called by GameRoom when empty)
